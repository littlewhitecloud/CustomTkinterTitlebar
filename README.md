...
文章：
                                            自定义标题栏
可以在“标题栏”里嵌套文本框
看到这里，你可能好奇这是怎么一回事了吧，那就是 —— “我把标题栏给重做了”
整个事情的大概：
一个月前，我就看到有许多自定义标题栏的样例，我很羡慕。
于是我就在想，tkinter能不能做到呢，于是，在我一个月以前就开始挖坑了……
直到这一个月，我才开始去填这个坑，因为终于到了周末嘛，我把作业在周五晚上都刷完了，并且也没什么事情，闲来无事，找到了遗弃下来的这个坑，于是就开始填了……
想法：
先overrideredirect窗口，使窗口失去标题栏&边框以及后面很麻烦的任务栏上的图标。
然后创建一个Frame, 设置图标，文本，最大化，最小化，关闭按钮~
最后在随便完善一下，就好了。
理论好像存在，实践有很多问题。
细节：
