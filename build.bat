...
echo Require VS 2020 ~ 2022 (2022 best)
echo If you set the cl.exe in system path, you can use this file to build dll in normal console. 
echo Use x64 Native Tools Command Prompt for VS 202x to build 64 bit dll
echo Use x86 Native Tools Command Prompt for VS 202x to build 32 bit dll
